...
struct Constants
{
  ...
  // Any command value changed notification from KVO collection
  static let NOTIFICATION_DEVICE_STATE_VALUE_CHANGED = "DEVICE_STATE_VALUE_CHANGED"
  
  // Specific events generated by DeviceContext
  static let NOTIFICATION_ADMINTREE_RECEIVED = "DEVICE_ADMINTREE_RECEIVED"
  ...
  static let NOTIFICATION_CHANNEL1_VALUE_CHANGED = "DEVICE_CHANNEL1_VALUE_CHANGED"
  static let NOTIFICATION_CHANNEL2_VALUE_CHANGED = "DEVICE_CHANNEL2_VALUE_CHANGED"
}
